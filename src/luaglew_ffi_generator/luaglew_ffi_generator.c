...
int main(int argc, char **argv)
{
 ...
 //header for FFI library
    ...
    get_list(argv[1],ffi_lib_list,1);
    fprintf(ffi_lib_list,"};\n\n\n");

    get_list(argv[1],ffi_lib_list,3);
    fprintf(ffi_lib_list,"\n\n\n");

    get_list(argv[1],ffi_lib_list,2);
    fprintf(ffi_lib_list,"\n\n\n");

//trailer for FFI library
    fprintf(ffi_lib_list,"]]\n\n");

    fprintf(ffi_lib_list,"return ffi.load(\"opengl32.dll\", \"glew32.dll\")\n\n");
